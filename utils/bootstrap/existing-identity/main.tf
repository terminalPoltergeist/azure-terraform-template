...
resource "azurerm_federated_identity_credential" "integration_credential" {
  depends_on          = [data.azurerm_user_assigned_identity.identity]
...
resource "github_actions_secret" "client_id" {
  ...
  plaintext_value = data.azurerm_user_assigned_identity.identity.client_id
}
...
resource "github_actions_secret" "tenant_id" {
  ...
  plaintext_value = data.azurerm_user_assigned_identity.identity.tenant_id
}
